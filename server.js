...
process.stdin.on("data", async (data) => {
  ...
  if (command === "reset") {
    try {
      await db.execute("UPDATE seats SET estado = 'libre'");
      console.log("✅ Asientos reiniciados correctamente en la base de datos");
    } catch (err) {
      console.error("❌ Error al reiniciar asientos:", err);
    }
  }
});
